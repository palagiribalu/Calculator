                ...
                <div class = "container">
                    ...
                    <div class = "collapse navbar-collapse navHeaderCollapse">
                        <ul class = "nav navbar-nav navbar-right">
                            ...
                            <li class = "active"><a href = "discover.php"><i class="fa fa-users fa-lg fa-spin"  style = "color: #f43333"></i>  Discover</a></li>
                ...
                <div class = "col-sm-9">
					...
					if(!$username) {
						...
						echo "<div class = 'alert alert-info'>
                        	<p><strong>Log in to start Tindering!</strong></p>
                        </div>";		
					} else {
							echo '<h2>Make love happen <br><small>Click nope or like</small></h2>';
						}

                    // TODO: Vastassoost kasutaja profiilid Like ja Nope nuppudega
